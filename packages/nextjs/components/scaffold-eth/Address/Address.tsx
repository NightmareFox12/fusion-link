      ...
      <div className="flex flex-col items-center">
        {showSkeleton &&
          (isEnsNameLoading ? (
            ...
            <span className={` ${textSizeMap[ensSize]} font-bold`}>
              <AddressLinkWrapper
        ...
        <div className="">
          <span className={`ml-1.5 ${textSizeMap[addressSize]} font-semibold`}>
            <AddressLinkWrapper
              disableAddressLink={disableAddressLink}
              blockExplorerAddressLink={blockExplorerAddressLink}
            >
          ...
          <AddressCopyIcon className={`ml-1 ${copyIconSizeMap[addressSize]}`} address={checkSumAddress} />
        </div>
      </div>
    </div>
  );
